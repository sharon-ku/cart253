class Nene extends Clownfish {
  ...
  // feedAnemone(anemone, fishName) {
  //   super.feedAnemone(anemone,fishName);
  ...
  //         // console.log(`Nene: true interacts with food`);
  //         return true;
  //       }
  //     }
  //   }
  ...
  //     }
  //   }
  //   // console.log(`Nene: false interacts with food`);
  //   return false;
  //
  //
  //
